...
newbound = shrinkspace(f_0_old,f_0_new,f_0_predict,x_0_new,x_0_old,...
    lower_bound,upper_bound,lower_bound_current,upper_bound_current, 1:dimension);
...
newbound = shrinkspace(f_0_old,f_0_new,f_0_predict,x_0_new,x_0_old,...
    lower_bound,upper_bound,lower_bound_current,upper_bound_current,K(1));
lower_bound_current = newbound(1,:);
upper_bound_current = newbound(2,:);
f_0_new
...
%     end
    ...
    NOE = NOE + 1;
    newbound = shrinkspace(f_0_old,f_0_new,f_0_predict,x_0_new,x_0_old,...
        lower_bound,upper_bound,lower_bound_current,upper_bound_current,K(1:dimension_number));
    lower_bound_current = newbound(1,:);
    upper_bound_current = newbound(2,:);
    if detect(f_0_old,f_0_new) == 1
        pause; 
