...
r2 = 0.75;
lambda = 0.05;
lower_bound_current_mem = lower_bound_current;
upper_bound_current_mem = upper_bound_current;
...
lower_bound_current_mem(dimension) = lower_bound_current(dimension);
upper_bound_current_mem(dimension) = upper_bound_current(dimension);
output_args = [lower_bound_current_mem;upper_bound_current_mem];
end