function [NOE,output_args, sample_point_temp, sample_value_temp] = construct_second_order( HDMR, f_append, sample_point_whole,sample_value,x_0,f_0,objective_function,NOE,K,lower_bound, upper_bound, second_order_count, sample_point, x_0_old)
...
for loop = 1:8*(second_order_count) + 8
