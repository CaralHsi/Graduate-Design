...
lower_bound = repmat(-100,1,dimension);
upper_bound = repmat(100,1,dimension); % the feasible zone of variables
lower_bound_current = lower_bound;
upper_bound_current = upper_bound;
objective_function = @(x)loadfunc(10,x); % load the objective function
% x_0 = repmat(0.5,1,dimension); % initialize const term x_0
